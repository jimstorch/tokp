...
test1 = (date(2007,10,23), "Participation", 1)
test2 = (date(2007,10,30), "Participation", 4)
test3 = (date(2007,11,02), "Loot", "Epic", "Epic Helm of Crap")
test4 = (date(2007,11,06), "Participation", 3)
...
def add_points(Participation, DaysElapsed):
##
##    # are points decaying?
##    if Participation == 0:
